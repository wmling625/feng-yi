            ...
            <div class="row justify-content-center no-gutters">
                <div class="col-lg-7">
                    <div class="reply-section">
                        <form action="comment_end.php" method="post"
                            ...
                            <div class="reply-item">
                                ...
                                <div class="reply-box <?php echo $hidden; ?>">
                                    <textarea class="form-control" name="contents1" id="contents1"
                                              placeholder="請輸入回覆內容，送出後需間隔5分鐘後才可再次回覆" cols="30"
                                              rows="3"><?php echo isset($result_arr[0]['contents1']) ? br2nl($result_arr[0]['contents1']) : ""; ?></textarea>
                            ...
                            <input type="hidden" name="user_id0"
                                   value="<?php echo aes_encrypt($result_arr[0]['user_id0']); ?>">
                            <input type="hidden" name="user_id1"
                                   value="<?php echo aes_encrypt($result_arr[0]['user_id1']); ?>">
                            <input type="hidden" name="license"
                                   value="<?php echo aes_encrypt($result_arr[0]['license']); ?>">
                        </form>
                    </div>
                </div>
            </div>
