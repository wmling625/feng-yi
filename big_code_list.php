            ...
            <div class="title-box">
                <div class="container container-shrink">
                    <div class="row justify-content-center no-gutters">
                        <div class="col-lg-12">
                            <h4 class="title font-weight-6">所屬單位條碼 總數：<?php echo count($result_arr); ?>
            ...
            <div class="container container-shrink">
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-12">
                        <div class="code-list">
                            <?php
                            if (count($result1_arr) > 0) {
                                foreach ($result1_arr as $v) {
                                    $qrcode = $v['qrcode_id'];
                                }
                            }
                            if (count($result_arr) > 0) {
                                foreach ($result_arr as $key => $value) {
                                    $link = $_SERVER['REQUEST_SCHEME'] . "/big_code.php?qr_type_big_id=" . aes_encrypt($value['qr_type_big_id']);
                                    // $link = "big_my_info.php?qrcode_big_id=" . aes_encrypt($value['qrcode_big_id']) . "&profile=$profile&qrcode_id=$qrcode";
