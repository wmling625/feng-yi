...
$query = "SELECT * FROM `pintech_logs`.`list` WHERE `id`='" . $id . "'";
                        ...
                        <div class="card">
                            <div class="card-body table-responsive-sm">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th width="25%">資料表名稱</th>
                                        <td>
                                            <?php echo isset($result_arr[0]['table_name']) ? $box_arr[$result_arr[0]['table_name']] . ' <code>' . $result_arr[0]['table_name'] . '</code>' : ""; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th width="25%">動作</th>
                                        <td>
                                            <?php echo isset($result_arr[0]['model']) ? $result_arr[0]['model'] : ""; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th width="25%">內容<br/><span class="text-xs text-danger font-weight-normal">刪除前或更新前</span>
                                        </th>
                                        <td>
                                            <?php
                                            if (isset($result_arr[0]['contents'])) {
                                                echo '<pre class="m-0">';
                                                echo json_encode(json_decode($result_arr[0]['contents'], true), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
                                                echo '</pre>';
                                            }
                                            ?>
                                        </td>
