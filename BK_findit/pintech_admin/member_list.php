...
$url_param = add_pararm($_SERVER['PHP_SELF'], array("date_type" => $date_type, "min_date" => $min_date, "max_date" => $max_date, "types" => $types, "keyword" => $keyword, "orders" => $orders, "paid" => $paid, "limit" => $limit, "items" => $items));
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 mt-2">
                                        <select class="form-control" name="items" data-bs-toggle="tooltip" title="性別"
                                                search_ref>
                                            <?php echo gen_options($search_items, $items) ?>
                                        </select>
                                    </div>
                                    <div class="col-md-3 col-sm-6 mt-2">
                                        <input type="text" class="form-control" name="keyword" data-bs-toggle="tooltip"
                                               title="會員姓名、手機"
                                               placeholder="請輸入會員姓名 手機"
