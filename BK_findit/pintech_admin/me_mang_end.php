...
if (count($err_msg)) {
    ...
    if ($model == "add") {
        ...
        if ($passwd == "") {
            $query = "update admin set nickname = '" . $nickname . "', account = '" . $account . "', note = '" . $note . "' ";
        } else {
            $query = "update admin set nickname = '" . $nickname . "', account = '" . $account . "', note = '" . $note . "', passwd = '" . md5($passwd) . "' ";
        }
