...
$result_type_big_arr = array();

$qrcode_big = "SELECT * FROM `qrcode_big` WHERE `qr_type_big_id` = '" . $qr_type_big_id . "';";
...
// if ($result = $mysqli->query($query_type_big)) {
//     while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
//         $result_big_arr[] = $row;
//     }
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6 mt-2">
                                            <input type="text" class="form-control" data-bs-toggle="tooltip" title="單位名稱" name="keyword" placeholder="請輸入單位名稱" value="<?php echo $keyword; ?>" search_ref>
                                        </div>
