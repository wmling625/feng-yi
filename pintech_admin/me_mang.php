                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input readonly req data-title="暱稱" class="form-control" name="nickname" value="<?php echo isset($result_arr[0]["nickname"]) ? $result_arr[0]["nickname"] : "" ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="20%">帳號<span class="required">*</span></th>
                                                    <td>
                                                        <input readonly req data-title="帳號" class="form-control" name="account" value="<?php echo isset($result_arr[0]["account"]) ? $result_arr[0]["account"] : "" ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="20%">
                                                    ...
                                                    <td>
                                                        <input <?php echo ($model == "add") ? "req" : "" ?> data-title="密碼" type="password" class="form-control" name="password">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="20%">
                                                    ...
                                                    <td>
                                                        <input <?php echo ($model == "add") ? "req" : "" ?> data-title="密碼確認" type="password" class="form-control" name="password2">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="20%">分會</th>
                                                    <td>
                                                        ...
                                                        foreach ($result_big_arr as $value) {
                                                            if ($result_arr[0]["qr_type_big_id"] == $value["qr_type_big_id"]) { ?>
                                                                <input readonly req data-title="單位管理權限" class="form-control" name="qr_type_big_id" value="<?php echo isset($value["qr_type_big_id"]) ?  $value["title"] : "" ?>">
                                                        <?php }
                                                        }
                                                        ?>
                                                    </td>
