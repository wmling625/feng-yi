                            ...
                            <div class="card-header">
                                <div class="card-tools">
                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                            data-bs-toggle="tooltip" title="發送QRCode"
                                            id="sendToMember">
                                        發送
                                    </button>
                                    <a href="qrcode_mang.php?model=add" type="button"
                                       class="btn btn-sm btn-success">批次新增</a>
                                    <button type="button" class="btn btn-sm btn-danger" name="box_del">批次刪除</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary"
                                            data-bs-toggle="tooltip" title="根據搜尋結果匯出（至多2000筆）" name="excel_button">
                                        匯出Excel
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary"
                                            data-bs-toggle="tooltip" title="根據搜尋結果下載（至多2000筆）" name="zip_button">
                                        下載QRCode圖片
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 mt-2">
                                        <select class="form-control" name="send" data-bs-toggle="tooltip" title="發送狀態"
                                                search_ref>
                                            <?php echo gen_options($search_send, $send) ?>
                                        </select>
                                    </div>
                                    <div class="col-md-3 col-sm-6 mt-2">
                                        <select class="form-control" name="orders" data-bs-toggle="tooltip" title="綁定狀態"
                                                search_ref>
                                            <?php echo gen_options($search_orders, $orders) ?>
                                        </select>
                                    </div>
                                    <div class="col-md-3 col-sm-6 mt-2">
                                        <select class="form-control" name="types" data-bs-toggle="tooltip" title="標籤"
                                                search_ref>
                                    ...
                                    <div class="col-md-6 col-sm-6 mt-2">
                                        <input type="text" class="form-control" data-bs-toggle="tooltip"
                                               title="QRCode名稱、會員名稱、綁定手機、暱稱、姓名"
                                               name="keyword"
                                               placeholder="請輸入QRCode名稱、會員名稱、綁定手機、暱稱、姓名"
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-bordered table-hover text-nowrap">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <th width="10%">圖片</th>
                                        <th width="10%">標籤群組<br/>
                                            <span class="text-sm text-muted font-weight-normal">QR名稱</span></th>
                                        <!--                                        <th width="10%">標籤群組</th>-->
                                        <th width="10%">會員資訊</th>
                                        <th width="10%">綁定資訊</th>
                                        <th>姓名</th><!--家屬-->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <select req data-title="會員" name="memberId"
