                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input req data-title="姓名" class="form-control" type="number"
                                                            name="account" placeholder="請輸入電話"
                                                ...
                                                <tr>
                                                    <th width="25%">社區</th>
                                                    <?php
                                                    $formArray = !empty($result_arr[0]["form"]) ? json_decode($result_arr[0]["form"], true) : [];
                                                    if (!empty($formArray)) {
                                                        foreach ($formArray as $index => $res) { ?>
                                                <tr>
                                                    <th width="25%"><?php echo $res['label']; ?><span class="required"></span></th>
                                                    <td>
                                                        <input req data-title="<?php echo $res['label']; ?>" class="form-control" type="hidden"
                                                            name="form[label][<?php echo $index; ?>]" value="<?php echo isset($res['label']) ? htmlspecialchars($res['label']) : "" ?>">
                                                        <input req data-title="<?php echo $res['label']; ?>" class="form-control" type="<?php echo $res['label']; ?>"
                                                            name="form[name][<?php echo $index; ?>]" placeholder="請輸入<?php echo $res['label']; ?>"
                                                            value="<?php echo isset($res['name']) ? $res['name'] : "" ?>">
                                                    </td>
                                                </tr>
                                        <?php   }
                                                    } ?>
