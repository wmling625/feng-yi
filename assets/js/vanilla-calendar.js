...
let VanillaCalendar = (function () {
    function VanillaCalendar(options) {
        ...
        const createDay = function (date) {
            ...
            var formatdate = getISODateTime(now_time(date), 'yyyy-MM-dd')
            dateElem.innerHTML = date.getDate()
            newDayElem.className = 'vanilla-calendar-date'
            newDayElem.setAttribute('data-calendar-date', formatdate)
        ...
        const createMonth = function () {
            ...
            opts.month_label.innerHTML = opts.date.getFullYear()+ ' ' +  opts.months[opts.date.getMonth()] 
            selectDate()
        }
